...
# so it will just like xXXXxXXXx
# use re is easily to find it
import re
find_ans = re.compile(r'[a-z][A-Z][A-Z][A-Z]([a-z])[A-Z][A-Z][A-Z][a-z]')
str1 = '''
...
'''
list1 = re.findall(find_ans,str1)
for i in list1:
    print(i,end='')

# go to next level http://www.pythonchallenge.com/pc/def/linkedlist.html